...
CREATE TABLE `Spectacles` (
  ...
  `nomSpectacle` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idSpectacle`),
  UNIQUE KEY `idSpectacle_UNIQUE` (`idSpectacle`),
  KEY `idCategoriefk` (`idCategorie`),
  CONSTRAINT `idCategoriefk` FOREIGN KEY (`idCategorie`) REFERENCES `Categories` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Spectacles` VALUES (5,'HUM','une description','moi',15,'Un GUID',NULL),(6,'HUM','une description','toi',20,'Un GUID',NULL),(7,'DAN','une description','ben',25,'Un GUID',NULL),(8,'DAN','une description','bob',30,'Un GUID',NULL),(9,'THE','une description','charles',35,'Un GUID',NULL);
...
-- Dump completed on 2020-04-27 12:22:57
