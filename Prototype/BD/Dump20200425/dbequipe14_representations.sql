...
CREATE TABLE `representations` (
  ...
  CONSTRAINT `fk_idSalle` FOREIGN KEY (`idSalle`) REFERENCES `salles` (`idSalle`),
  CONSTRAINT `fk_idSpectacle` FOREIGN KEY (`idSpectacle`) REFERENCES `spectacles` (`idSpectacle`)
...
-- Dump completed on 2020-04-25 14:05:28
